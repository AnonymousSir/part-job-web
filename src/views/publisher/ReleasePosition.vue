  ...
  <div class='release_position'>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button type="primary" v-mythrottle="['click', [subForm, ruleFormRef], 1000]">提交信息</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
  ...
  setup(props, context) {
    ...
    const subForm = (formEl) => {
      ...
      formEl.validate(async (valid, fields) => {
        ...
        const res = await $axios.post('/company/information', {
